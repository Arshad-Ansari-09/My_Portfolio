    ...
    <footer className="footer">
      ...
      <div className="footer__bottom">
        ...
        <div style={{ display: "flex", gap: "1.5rem" }}>
          <a href="https://github.com/arshad-ansari-09" target="_blank" rel="noreferrer">GitHub</a>
          <a href="https://linkedin.com/in/arshad-ansari-profile" target="_blank" rel="noreferrer">LinkedIn</a>
