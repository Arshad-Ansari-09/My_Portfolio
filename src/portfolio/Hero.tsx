...
export function Hero() {
  ...
  useEffect(() => {
    ...
    gsap.fromTo(letters, { y: "110%" }, { y: "0%", duration: 1.1, ease: "power4.out", stagger: 0.06, delay: 0.2 });
    gsap.from(".hero__meta, .hero__sub, .hero__cta, .hero__footer", {
      y: 40, opacity: 0, duration: 1, ease: "power3.out", stagger: 0.1, delay: 0.7,
    });

    return () => { stopGrid(); window.removeEventListener("mousemove", onMove); };
  }, []);
  ...
  return (
    <section className="hero" id="hero">
      ...
      <div className="hero__shape hero__shape--circle" style={{ top: "15%", right: "8%", width: 220, height: 220 }} />
      <div className="hero__shape" style={{ bottom: "22%", left: "6%", width: 120, height: 120, transform: "rotate(35deg)" }} />
      <div className="hero__shape" style={{ top: "55%", right: "20%", width: 60, height: 60, transform: "rotate(15deg)" }} />
